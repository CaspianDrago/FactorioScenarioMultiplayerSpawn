...
WELCOME_MSG = "Welcome to CaspianDrago's Server"
...
CONTACT_MSG = "Contact:CaspianDrago on discord | discord.gg/shFcPfq"
...
OARC_MODIFIED_ENEMY_SPAWNING = false
...
ENFORCE_LAND_AREA_TILE_DIST = 140
